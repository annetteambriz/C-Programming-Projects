...
// Done TODO - Transition these prototypes from using arrays to
...
void printEmpStatistics (struct totals * employeeTotalsPtr,
                         struct min_max * employeeMinMaxPtr,
                         int theSize);
...
int main ()
{
    ...
    struct employee employeeData[SIZE] = {
        { {"Coonie", "Cobol"}, "MA", 98401, 10.60},
        { {"Mary", "Apl"}, "NH", 526488, 9.75 },
        { {"Keith", "Fortran"}, "VT", 765349, 10.50 },
        { {"Annette", "Ada"}, "NY", 34645, 12.25 },
    ...
    * ptr = 7;
    ...
    // Done TODO - Transition this call to using pointers.
...
// Parameters: 
//
//   employeeTotalsPtr - a pointer to a structure containing a running total
//                    of all employee floating point items 
//   employeeMinMaxPtr - a pointer to a structure containing all the minimum
...
// Done TODO - Transition this function from Structure references to
                         ...
                         int theSize)
{
    ...
    printf("\nTotals:                         %5.2f %5.1f %5.1f %7.2f %6.2f %7.2f %8.2f",
           employeeTotalsPtr->total_wageRate,
           employeeTotalsPtr->total_hours,
           employeeTotalsPtr->total_overtimeHrs,
           employeeTotalsPtr->total_grossPay,
           employeeTotalsPtr->total_stateTax,
           employeeTotalsPtr->total_fedTax,
           employeeTotalsPtr->total_netPay);
    ...
    if (theSize > 0)       
    {
        ...
        printf("\nAverages:                       %5.2f %5.1f %5.1f %7.2f %6.2f %7.2f %8.2f",
               employeeTotalsPtr->total_wageRate/theSize,
               employeeTotalsPtr->total_hours/theSize,
               employeeTotalsPtr->total_overtimeHrs/theSize,
               employeeTotalsPtr->total_grossPay/theSize,
               employeeTotalsPtr->total_stateTax/theSize,
               employeeTotalsPtr->total_fedTax/theSize,
               employeeTotalsPtr->total_netPay/theSize);
    } // if
    
    // print the min and max values
    
    printf("\nMinimum:                        %5.2f %5.1f %5.1f %7.2f %6.2f %7.2f %8.2f",
           employeeMinMaxPtr->min_wageRate,
           employeeMinMaxPtr->min_hours,
           employeeMinMaxPtr->min_overtimeHrs,
           employeeMinMaxPtr->min_grossPay,
           employeeMinMaxPtr->min_stateTax,
           employeeMinMaxPtr->min_fedTax,
           employeeMinMaxPtr->min_netPay);
    
    printf("\nMaximum:                        %5.2f %5.1f %5.1f %7.2f %6.2f %7.2f %8.2f",
           employeeMinMaxPtr->max_wageRate,
           employeeMinMaxPtr->max_hours,
           employeeMinMaxPtr->max_overtimeHrs,
           employeeMinMaxPtr->max_grossPay,
           employeeMinMaxPtr->max_stateTax,
           employeeMinMaxPtr->max_fedTax,
           employeeMinMaxPtr->max_netPay);
...
// Done TODO - Transition this function from Array references to
                         ...
                         int theSize)
{
    ...
    // employeeMinMax structure from its calling function ...
