...
// Done TODO - Create a macro called CALC_FED_TAX.  It will be very similar
//        to the CALC_STATE_TAX macro above.  Then call your macro in the
//        the calcFedTax function (replacing the current code)

#define CALC_FED_TAX(thePay,theFedTax) (thePay * theFedTax)
#define CALC_STATE_TAX(thePay,theStateTax) (thePay * theStateTax)
...
// Done TODO - These two macros are missing the correct logic, they are just setting
...
#define CALC_MIN(theValue, currentMin) (theValue < (currentMin) ? currentMin : theValue)
#define CALC_MAX(theValue, currentMax) (theValue > (currentMax) ? currentMax : theValue)
...
// DONE TODO - Add a typedef alias to this structure, call it: MIN_MAX
...
// Done TODO - Update these two prototypes with the MIN_MAX typedef alias
...
int main ()
{
    ...
    // Done TODO - Update these two variable declarations to use
...
// DONE TODO - Update the emp_MinMax_ptr parameter below to use the MIN_MAX
//        typedef alias
...
void calcFedTax (EMPLOYEE * head_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // Done TODO - Replace the below statement after the "=" with
...
// Done TODO - Update the emp_minMax_ptr parameter below to use the
//        the MIN_MAX typedef alias
