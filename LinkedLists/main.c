...
void calcGrossPay (struct employee * head_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        float theNormalPay = current_ptr->wageRate * (current_ptr->hours - current_ptr->overtimeHrs);
        float theOvertimePay = current_ptr->overtimeHrs * (OT_RATE * current_ptr->wageRate);
...
//          for each employee.  State tax rate is based on
...
void calcStateTax (struct employee * head_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // Completed TODO - Add all the missing code to properly update the
...
void calcFedTax (struct employee * head_ptr)
{
    ...
    // Completed TODO - Add a for Loop to traverse through the linked list
    //        to calculate the federal tax for each employee

    // Completed TODO - Inside the loop, using current_ptr
                         ...
                         struct totals * emp_totals_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // Done TODO - update these two statements below to correctly
                         ...
                         struct min_max * emp_minMax_ptr)
{
    ...
    for (; current_ptr; current_ptr = current_ptr->next) 
    {
        ...
        // Done TODO - Add code to check if the current state tax is our
        ...
        // Done TODO - Add code to check if the current federal tax is our
        //        new min and/or max items.   Right now the checks
        //        are missing.
