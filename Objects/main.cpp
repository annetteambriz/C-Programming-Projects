...
class Employee
{
    ...
    public:
        ...
        // Done TODO - Add public getter function prototype to retrieve stateTax
        float getStateTax();

        // Done TODO - Add public getter function prototype to retrieve fedTax
        float getFedTax();

        // Done TODO - Add public getter function prototype to retrieve netPay
                    ...
                    int myClockNumber, float myWageRate, float myHours)
{
    ...
    // Done TODO - set stateTax as the return from calcStateTax member function
    stateTax = calcStateTax();

    // Done TODO - set fedTax as the return from calcFedTax member function
    fedTax = calcFedTax();

    // Done TODO - set netPay as the return from calcNetPay member function
   netPay = calcNetPay();
...
// Done TODO - Add a "getter" function that will retrieve the employee stateTax
float Employee::getStateTax() {
    return stateTax;
}
// Done TODO - Add a "getter" function that will retrieve the employee fedTax
float Employee::getFedTax() {
    return fedTax;
}
// Done TODO - Add a "getter" function that will retrieve the employee netPay
...
void Employee::printEmployee(Employee e) {
    ...
    // Done TODO - Add cout statement with call to stateTax getter function
    cout <<"\n State Tax : $" <<  e.getStateTax();

    // Done TODO - Add cout statement with call to fedTax getter function
    cout <<"\n Fed Tax : $" <<  e.getFedTax();

    // Done TODO - Add cout statement with call to netPay getter function
    cout <<"\n Net Pay : $" <<  e.getNetPay();
